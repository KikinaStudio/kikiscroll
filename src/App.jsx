                        ...
                        <div className="max-w-2xl w-full pointer-events-auto filter drop-shadow-2xl z-10">
                            ...
                            {section.hasWebcamButton && (() => {
                                ...
                                >
                                    ...
                                    {/* Before activation: short privacy reassurance + a discreet
                                        "no recording" eye-off icon (≈14px, stroke 1.5, text colour). */}
                                    {!isCameraActive && !cameraError && (
                                        <p className="flex items-center gap-2 text-[11px] leading-relaxed text-tenbin-gray max-w-xs">
                                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="flex-shrink-0" aria-hidden="true">
                                                <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"/>
                                                <line x1="1" y1="1" x2="23" y2="23"/>
                                            </svg>
                                            <span>{t.webcam_hint}</span>
                                        </p>
                                    )}
