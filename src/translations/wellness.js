const wellness = {
  fr: {
    ...
    s0_p1: "Chaque spa porte un climat sonore qui agit sur le système nerveux avant le premier soin. Il est souvent la première sensation reçue par le client, et l'une des dernières impressions qu'il emporte.",
